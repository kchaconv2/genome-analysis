...
Countries <- global_time_series %>% 
  select(Country_Region) %>% 
  filter (Country_Region %in% c("US","Colombia","Brazil","Peru","Ecuador","Chile","Venezuela","Bolivia","Argentina","Paraguay","Uruguay"))
#Countries = global_time_series$Country_Region #optional for all countries
